        ...
        return {
            authors: [
                ...
                },
                {
                    ...
                    description:
                        "Docente do Instituto Federal do Paraná - Campus Assis Chateaubriand",
                },
            ],
        };
    },
...
.navbar-container {
    ...
    margin: 0 15px;
    padding: 0px 0;
    height: 15px; /* Ajuste o valor para a altura desejada */ 
...
/* Seção de autores */
.authors-section {
  padding: 40px 20px; /* Espaçamento adicional */
}

.author {
  width: 25%; /* Ajuste a largura dos contêineres */
  margin-bottom: 30px;
...
.author img {
  ...
  margin-bottom: 15px; /* Espaçamento entre foto e nome */
}

.author h3 {
  font-size: 1.2em; /* Tamanho de fonte maior para o nome */
  margin-bottom: 10px;
}

.author p {
  font-size: 1em; /* Tamanho de fonte padrão para a descrição */
  color: #555; /* Cor de texto */
}

/* Navbar */
.navbar-container {
  background-color: #333; /* Cor de fundo da navbar */
  color: #fff; /* Cor de texto da navbar */
}
